...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleAuthenticationError(AuthenticationException ex) {
        ApiResponse<Void> response = ApiResponse.error(ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<Void>> handleAuthorizationError(AuthorizationDeniedException ex) {
